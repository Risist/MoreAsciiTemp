...
[CreateAssetMenu(fileName = "SwordShieldWeapon", menuName = "Character/Weapon/SwordShield")]
public class CharacterWeaponSwordShield : CharacterWeaponBase
{
    public override void InitCharacterStateController(CharacterStateController stateController)
    {
        ...
        int cdPush = stateController.CreateCd(0.75f);
        ...
        slash
            ...
            .AddComponent(new CState_RotationToDirection(new RangedFloat(0, 0.5f), 0.1f, 0.65f))
            //.AddComponent(new CState_JumpMotor(new float[] { 300, -100 }, new RangedFloat(0.325f, 0.425f), -100.0f).SetDefaultDirection(0))
            .AddComponent(new CState_Motor(new Vector2(0, 350.0f), new RangedFloat(0.325f, 0.4f)))
            .AddComponent(new CState_AutoTransition(idle, 1f))

            .AddTransition(block, new RangedFloat(0.6f), new AnimationTransitionData(0.125f, 0f))
            .AddTransition(push, new RangedFloat(0.75f), new AnimationTransitionData(0.2f, 0.0f))
        ;
        push
            .AddComponent(new CState_Input(1))
            .AddComponent(new CState_Cd(cdPush))
            //.AddComponent(new CState_Cd(cdBlock, CState_Cd.EMode.ERestartOnly))
            .AddComponent(new CState_RotationToDirection(new RangedFloat(0, 0.5f), 0.125f, 0.85f))
            //.AddComponent(new CState_JumpMotor(new float[] { 275, -100, 250, 250 }, new RangedFloat(0.050f, 0.135f), -100.0f).SetDefaultDirection(0))
            .AddComponent(new CState_Motor(new Vector2(0, 272.0f), new RangedFloat(0.050f, 0.135f)))
            .AddComponent(new CState_Motor(new Vector2(0, -200.0f), new RangedFloat(0.325f, 0.475f)))
            .AddComponent(new CState_AutoTransition(idle, 1f))

            .AddTransition(block, new RangedFloat(0.6f), new AnimationTransitionData(0.125f, 0f))
            .AddTransition(slash, new RangedFloat(0.75f), new AnimationTransitionData(0.2f, 0.0f))
        ;
        ...
        block
            ...
            .AddTransition(slash, new RangedFloat(0.375f), new AnimationTransitionData(0.2f, 0.1f))
